<x-guest-layout>
    ...
    <section class="project-hero">
      ...
      <p class="section-label">Mobile · HealthTech</p>
      <h1>Pulse Health App</h1>
      <p>AI‑powered telemedicine platform connecting over 500,000 patients with certified specialists in under 60 seconds, with smart symptom triage and secure video consultations.</p>
      <div class="project-tags">
        <span class="project-tag">React Native</span>
        <span class="project-tag">Node.js</span>
        <span class="project-tag">WebRTC</span>
        <span class="project-tag">TensorFlow Lite</span>
        <span class="project-tag">Firebase</span>
        <span class="project-tag">HIPAA Compliant</span>
      </div>
    </section>

    <!-- Content -->
    <div class="content-container">
      <div class="project-image">[ Pulse Health App Interface ]</div>

      <!-- Overview & Metrics -->
      <div class="grid-2col">
        <div class="glass-card">
          <h2 style="font-size:1.6rem; color:var(--cyan); margin-bottom:1rem;">Overview</h2>
          <p style="color:var(--white-muted); line-height:1.7;">Pulse Health started as a startup idea to bridge the gap between patients in rural areas and urban specialists. Areia Soft designed and developed the complete iOS/Android app, built a real‑time video consultation engine, and integrated an on‑device AI symptom checker that operates even offline. The app now serves 500k+ active users across 12 countries.</p>
        </div>
        <div class="glass-card" style="display:flex; flex-direction:column; justify-content:center;">
          <div class="grid-2col" style="gap:1rem;">
            <div class="metric-box"><div class="metric-number">500k+</div><div class="metric-label">active users</div></div>
            <div class="metric-box"><div class="metric-number">&lt;60s</div><div class="metric-label">avg. wait time</div></div>
            <div class="metric-box"><div class="metric-number">4.8★</div><div class="metric-label">app store rating</div></div>
            <div class="metric-box"><div class="metric-number">12</div><div class="metric-label">countries</div></div>
          </div>
        </div>
      </div>
      ...
      <div class="glass-card">
        ...
        <ul class="feature-list">
          <li>On‑device AI symptom checker using TensorFlow Lite</li>
          <li>HD video consultations with WebRTC, including screen sharing and chat</li>
          <li>Electronic prescriptions and integrated pharmacy ordering</li>
          <li>Offline mode for medical history access in low‑connectivity areas</li>
          <li>Multi‑language support (English, Spanish, French, Swahili)</li>
          <li>End‑to‑end encryption, HIPAA & GDPR compliant data storage</li>
        </ul>
      </div>
      ...
      <div class="grid-2col">
        ...
        <div class="glass-card">
          ...
          <div class="testimonial">
            "Areia Soft didn’t just build an app—they partnered with us to redefine telemedicine. The AI triage alone reduced unnecessary ER visits by 30%."
          </div>
          <div class="testimonial-author">— Dr. Lisa Omondi, Co‑founder, Pulse Health</div>
        </div>
      </div>
      ...
      <div style="text-align:center; margin-top:3rem;">
        ...
        <a href="contact.html" class="btn-primary">Start Your HealthTech Project</a>
      </div>
    </div>
</x-guest-layout>