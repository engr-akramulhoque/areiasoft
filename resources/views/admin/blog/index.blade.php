<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div
            ...
            {{-- Card Header --}}
            <div
                class="flex flex-col gap-4 border-b border-gray-200 px-5 py-4 dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <div class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                                                ...
                                                {{ Str::limit($blog->excerpt ?? 'No excerpt available.', 65) }}
                                        ...
                                        @can('edit_blog')
                                            <form action="{{ route('admin.blogs.toggle-status', $blog) }}" method="POST">
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <i
                                                        class="bi {{ $blog->status === 'published' ? 'bi-toggle-on' : 'bi-toggle-off' }} text-base">
                                                    </i>
            ...
            <div id="blogSearchEmptyState" class="hidden px-4 py-14 text-center">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Try searching with a different title, slug, category, or status.
                </p>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document
                    .querySelectorAll('.delete-blog-form')
