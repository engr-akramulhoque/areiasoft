            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="5"
                        ...
                        class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 placeholder-gray-400 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm resize-y">{{ old('description', $blogCategory->description) }}</textarea>
                ...
                <div class="lg:col-span-2">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-400">
                            Active categories can be used when publishing blog posts.
                        </span>
                    </div>
