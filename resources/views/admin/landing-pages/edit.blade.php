        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="min-w-0">
                ...
                <div class="mb-2 flex items-center gap-2">
                    ...
                    <span
                        class="inline-flex items-center gap-1.5 rounded-full bg-yellow-100 px-2.5 py-1 text-xs font-medium text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400">
                ...
                <h1 class="break-words text-2xl font-bold text-gray-900 dark:text-gray-100 sm:text-3xl">
                    Edit SEO Landing Page
                </h1>

                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Update the content, structure and publication settings of this landing page.
                </p>
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                @can('view_landing_page')
                    <a href="{{ route('admin.seo-landing-pages.show', $page) }}"
                        class="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-500 px-4 py-2 text-sm text-white transition hover:bg-blue-600">
        ...
        <form action="{{ route('admin.seo-landing-pages.update', $page) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6 lg:col-span-2">
                            ...
                            <div class="flex items-center gap-3 px-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                                        Update the basic information for this landing page.
                                    </p>
                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="title" id="title"
                                        value="{{ old('title', $page->title) }}" placeholder="Website Development"
                                        required autofocus
                                ...
                                <div>
                                    ...
                                    <input type="text" name="slug" id="slug"
                                        value="{{ old('slug', $page->slug) }}" placeholder="website-development"
                                        required
                                        class="mt-1 block w-full rounded-lg border-gray-300 bg-white text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-500">
                        ...
                        <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-700">
                            ...
                            <div class="flex items-center gap-3 px-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                                        Update the main content visitors see first.
                                    </p>
                        ...
                        <div class="space-y-5 p-5">
                            ...
                            <div>
                                ...
                                <textarea name="hero_description" id="hero_description" rows="4"
                                    ...
                                    class="mt-1 block w-full resize-y rounded-lg border-gray-300 bg-white text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-500">{{ old('hero_description', $page->hero_description) }}</textarea>
                        ...
                        <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-700">
                            ...
                            <div class="flex items-center gap-3 px-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                                        Update the primary and secondary actions.
                                    </p>
                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_cta" id="primary_cta"
                                        value="{{ old('primary_cta', $page->primary_cta) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_cta_url" id="primary_cta_url"
                                        value="{{ old('primary_cta_url', $page->primary_cta_url) }}"
                                        placeholder="/contact"
                                        class="mt-1 block w-full rounded-lg border-gray-300 bg-white text-sm text-gray-900 shadow-sm focus:border-green-500 focus:ring-green-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="secondary_cta" id="secondary_cta"
                                        value="{{ old('secondary_cta', $page->secondary_cta) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="secondary_cta_url" id="secondary_cta_url"
                                        value="{{ old('secondary_cta_url', $page->secondary_cta_url) }}"
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-description">
                                    Update the trust signals displayed near the hero section.
                                </p>
                            </div>
                        ...
                        <div class="section-body">
                            ...
                            <div id="trustPointsContainer" class="space-y-3">
                                ...
                                @forelse (old('trust_points', $page->trust_points ?? []) as $point)
                    ...
                    @php
                        $problem = old('problem', $page->problem ?? []);
                    @endphp
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-body space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="problem[title]" value="{{ $problem['title'] ?? '' }}"
                            ...
                            <div>
                                ...
                                <textarea name="problem[text]" rows="4" placeholder="Explain the customer problem..." class="form-input">{{ $problem['text'] ?? '' }}</textarea>
                            ...
                            <div>
                                ...
                                <div id="problemPointsContainer" class="space-y-3">
                                    ...
                                    @forelse (($problem['points'] ?? []) as $point)
                                        <div class="repeater-item">
                    ...
                    @php
                        $solution = old('solution', $page->solution ?? []);
                    @endphp
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-body space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="solution[title]" value="{{ $solution['title'] ?? '' }}"
                            ...
                            <div>
                                ...
                                <textarea name="solution[text]" rows="4" placeholder="Explain your solution..." class="form-input">{{ $solution['text'] ?? '' }}</textarea>
                            ...
                            <div>
                                ...
                                <div id="solutionPointsContainer" class="space-y-3">
                                    ...
                                    @forelse (($solution['points'] ?? []) as $point)
                                        <div class="repeater-item">
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-description">
                                    Update the key services or capabilities offered.
                                </p>
                            </div>
                        ...
                        <div class="section-body">
                            ...
                            <div id="capabilitiesContainer" class="space-y-4">
                                ...
                                @forelse (old('capabilities', $page->capabilities ?? []) as $index => $capability)
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-description">
                                    Update the steps customers can expect.
                                </p>
                            </div>
                        ...
                        <div class="section-body">
                            ...
                            <div id="processContainer" class="space-y-4">
                                ...
                                @forelse (old('process', $page->process ?? []) as $index => $process)
                                    <div class="repeater-card">
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-description">
                                    Update technologies, frameworks and platforms.
                                </p>
                            </div>
                        ...
                        <div class="section-body">
                            ...
                            <div id="technologiesContainer" class="space-y-3">
                                ...
                                @forelse (old('technologies', $page->technologies ?? []) as $technology)
                                    <div class="repeater-item">
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-description">
                                    Update the business benefits customers receive.
                                </p>
                            </div>
                        ...
                        <div class="section-body">
                            ...
                            <div id="benefitsContainer" class="space-y-3">
                                ...
                                @forelse (old('benefits', $page->benefits ?? []) as $benefit)
                                    <div class="repeater-item">
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-description">
                                    Update questions and answers related to this landing page.
                                </p>
                            </div>
                        ...
                        <div class="section-body">
                            ...
                            <div id="faqsContainer" class="space-y-4">
                                ...
                                @forelse (old('faqs', $page->faqs ?? []) as $index => $faq)
                                    <div class="repeater-card">
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-description">
                                    Update the slugs of related landing pages for internal linking.
                                </p>
                            </div>
                        ...
                        <div class="section-body">
                            ...
                            <div id="relatedPagesContainer" class="space-y-3">
                                ...
                                @forelse (old('related_pages', $page->related_pages ?? []) as $relatedPage)
                                    <div class="repeater-item">
                    ...
                    <div
                        ...
                        <div class="space-y-5 p-5">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Active pages are visible to visitors.
                                </p>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (titleInput && slugInput) {
                    ...
                    let initialSlug = @json($page->slug);

                    let slugManuallyEdited =
                        slugInput.value.trim() !== initialSlug;
                ...
                document.addEventListener('click', function(event) {
                    ...
                    const removeButton =
                        event.target.closest('.remove-repeater');

                    if (removeButton) {

                        const parent =
                            removeButton.closest(
                                '.repeater-item, .repeater-card'
                            );
